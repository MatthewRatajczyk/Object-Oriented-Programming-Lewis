//made by the magic man Klump

abstract class Shape {
	private int x;
	private int y;
	/**
	 * Get set function for X
	 * @return
	 */
	public int getX() {
		return x;
	...
	/**
	 * This is that thing were you can have 2 classes with different paramaters
	 * I forgot what it was Function overloading.
	 */
	public Shape() {
		x = 0;
		y = 0;
